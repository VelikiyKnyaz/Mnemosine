...
2. Extrae 'entities' de alto valor (PERSON, LOCATION, EVENT). 
   - PERSON: Solo personas significativas mencionadas.
   - LOCATION: Solo lugares geográficos reales y específicos.
   - EVENT: Solo eventos de GRAN magnitud (Ej. boda, terremoto, graduación).
   ¡PROHIBIDO extraer objetos físicos genéricos (sillas, mascotas irrelevantes, carros) y prohibido extraer acciones o eventos triviales cotidianos!
...
6. Si un LUGARE o FECHA es extremadamente ambiguo y no se puede deducir lógicamente, añade "DATE_UNCLEAR" o "LOCATION_UNCLEAR" en el array 'ambiguities'.
